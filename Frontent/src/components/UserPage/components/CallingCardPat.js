...
export default function CallingCardPat({ data }) {
          ...
          >
            ...
            >
              ...
              <Typography sx={{ fontSize: '.8rem', mt: 1, fontWeight: 'bold' }} variant="p">
                Your appointment with Dr. {data?.doctor?.fullname} is in{' '}
        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ mb: 0 }} variant="">
                Phone: {data?.doctor?.phone_number || 'N/A'}
              </Typography>
              <Typography sx={{ fontSize: '.8rem', mt: 1, fontWeight: 'bold' }} variant="p">
