...
import ReportSplitCard from '../../../components/UserPage/components/ReportSplitCard';
import ReportSplitCardTwo from '../../../components/UserPage/components/ReportSplitCardTwo';
import { useGetallAppointment } from '../Hooks';
import StatusColor from 'src/components/StatusColor';
...
const ReportView = ({ propId, res }) => {
  ...
  const AppointOne = AllA?.filter((e) => e?._id === appointment?.appointment);
                ...
                >
                  ...
                  >
                    ...
                    <Typography variant="h7">
                      <FormattedDate date={AppointOne[0]?.appointment_date} />
                    </Typography>{' '}
                  </Box>
                  <Box
                    sx={{
                  ...
                  >
                    <Grid container spacing={8}>
                      <Grid item xs={12} sm={6}>
                        <ReportSplitCard data={AppointOne[0]} />
                      </Grid>
                      <Grid item xs={12} sm={6}>
                        <ReportSplitCardTwo data={appointment} />
                      </Grid>
                    </Grid>
                  </Box>
                </Card>
